...
description = (
    "On any operating system, automate creating and following blnk"
    " shortcut files (similar to X .desktop files), expanding"
    " %% or $ environment variables including %CLOUD% for"
    " ownCloud or Nextcloud default directories automatically."
)
...
setuptools.setup(
    ...
    url="https://github.com/poikilos/blnk",
    ...
    #   urllib (from blnk) (from versions: none)
